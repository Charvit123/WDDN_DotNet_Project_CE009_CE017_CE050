<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditSubject.aspx.cs" Inherits="Studentportal.EditSubject" %>
...
<body>
    ...
    <form id="form1" runat="server">
        <table>
            <tr>
                <td class="Title">Update Subject</td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="ubtn">
                    <asp:Button ID="Button1" CssClass="button" runat="server" OnClick="Button1_Click" Text="Update Subject" />
