<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Courses.aspx.cs" Inherits="Studentportal.Courses" %>
...
<body>
    <div class="nav">
            <ul class="nav-menu-inner">
                <li>
                    <a runat="server" class="an" href="AddSubject.aspx">Add Subject</a> 
                </li>
                <li>
    ...
    <img src="./Images/Login.jpg" class="auto-style1"/>
    <form id="form1" runat="server">
        ...
        <div class="inputgroup">
            ...
            <asp:Button ID="Button1" CssClass="button" runat="server" OnClick="Button1_Click1" Text="Filter" />
             ...
             <asp:GridView ID="GridView1" runat="server" AllowPaging="True" OnPageIndexChanging="GridView1_PageIndexChanging" PageButtonCount="4" AutoGenerateColumns="False" DataKeyNames="Id" BackColor="LightGoldenrodYellow" BorderColor="Tan" BorderWidth="1px" CellPadding="10" ForeColor="Black" GridLines="None" PageSize="5">
